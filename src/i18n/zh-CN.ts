...
export default {
    ...
    public: {
        ...
        publicKey: '公钥',
        privateKey: '私钥',
        invalidPrivateKey: '这不是一个合格的私钥, 请检查是否输错',
        noAccountForPrivateKey: '无法找到与此私钥对应的账号',
        invalidPublicKey: '公钥格式错误',
    ...
    resource: {
        ...
        smoothMode: '顺畅模式',
        smoothModeHint: '免费CPU，交易更顺畅',
        smoothModeHeadroom: '顺畅模式可用额度',
        estimatedCost: '预计花费',
        estimatedGet: '预计得到',
        ...
        otherAccount: '他人',
        refundNow: '立刻赎回',
        resourceReceiver: '接收账户',
        transfersEstimated: '预计可转账 {{count}} 次',
        chooseAmount: '选择金额',
    },
    ...
    setting: {
        ...
        manageNetworks: '网络管理',
        confirmDelete: '确定删除?',
        confirmRemoveKey: '确定移除此公钥？',
        confirmRemoveAccount: '确定要删除这个账号吗？',
        confirmDestroy: '确定销毁钱包中存储的所有数据吗？',
    ...
    wallet: {
        ...
        searchTip: '搜索账号',
        onlySendToken: '只能发送EOS链上资产，否则会造成资产丢失',
        accountAddress: '账户地址',
        scanQRCodeToPay: '扫描二维码付款',
        enterAmount: '请输入金额',
        enterReceiver: '请输入收款方账号',
        selectToken: '选择代币',
    },
    ...
    auth: {
        ...
        searchAccounts: '搜索账号',
        selectAccount: '选择账号',
        selectAccountTip: '选择你要登录的帐号和对应权限',
        login: '登录',
        chooseAccount: '选择账号',
        back: '返回',
        loginTip: '网站 {0} 请求授权',
